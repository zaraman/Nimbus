...
contract MockSmartLP is SmartLPStorage, IBEP721, IBEP721Metadata {
    ...
    function initialize(
        ...
        // require(AddressUpgradeable.isContract(_lendingContract), "NimbusSmartLP_V1: Not contract");
    ...
    //   _balancesRewardEquivalentBnbGnbu[tokenCount] += amountRewardEquivalentBnbGnbu;
      ...
      userSupply.GnbuBnbLpAmount = 1;
      userSupply.NbuBnbLpAmount = 1;
      userSupply.NbuBnbStakeNonce = 1;
      userSupply.GnbuBnbStakeNonce = 1;
