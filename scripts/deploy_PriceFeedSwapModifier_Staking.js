...
async function main() {
    ...
    console.log(`PriceFeedSwapModifier (Staking) deployed: ${contract.address} by ${deployer.address}`);

    console.log('Set up contract')
    // await contract.setTokenAlias(NIMB, NBU).then(async res=> await res.wait().then(console.log('Swap alias for NIMB -> NBU')));
